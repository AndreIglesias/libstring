...
#    Updated: 2021/06/15 14:28:33 by ciglesia         ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
SRCCALL		=	ft_strmap.c ft_strndup.c ft_strrev.c ft_strsub.c ft_strjoin.c ft_strmapi.c ft_strnew.c ft_strsplit.c ft_strtrim.c ft_memalloc.c ft_fstrjoin.c
